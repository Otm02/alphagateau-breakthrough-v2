...
- Breakthrough is a 2 player game played on a chess-like board
  - It is simple to describe but tactics are geometry-dependent
- Compare a GNN to a CNN model
...
- CNN & GNN from scratch on 5x5 and 8x8 boards
  - Also implemented cosine decay learning rate for GNN
...
- 5x5 → 6x6 → 8x8 experiment still in progress
...
- Confirms GNN is a good architecture for Breakthrough with low compute budget
