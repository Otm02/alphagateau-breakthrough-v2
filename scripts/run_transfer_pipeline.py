...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the 5x5 pretrain -> 8x8 zero-shot -> 8x8 fine-tune pipeline.")
    ...
    zero_shot_summary = evaluate_against_greedy(
        env=env_8x8,
    ...
    summary = {
        ...
        "zero_shot_8x8": zero_shot_summary,
